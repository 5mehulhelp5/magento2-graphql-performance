...
/**
 * Type resolver for CacheableField interface
 */
class CacheableFieldResolver implements TypeResolverInterface
{
    /**
     * Determine concrete type for CacheableField interface
     *
